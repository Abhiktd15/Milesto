            ...
            <div className='mb-3 flex w-full'>
                ...
                <div className='flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-secondary'>
                    <h3 className='flex items-center text-lg font-semibold dark:text-white'>
                        {status}{" "}
                        <span className='ml-2 inline-block rounded-full bg-gray-200 p-1 text-center text-sm leading-none dark:bg-gray-500 dark:text-primary' style={{width:"1.5rem",height:"1.5rem"}}>
                            {taskCount}
                        </span>
                    </h3>
                    <div className='flex items-center gap-1'>
                        ...
                        <button onClick={() => setIsModalNewTaskOpen(true)} className='flex size-6 items-center justify-center rounded bg-gray-200 dark:bg-dark-300'>
                            <Plus size={16}/>
                        </button>
                    </div>
                </div>
